...
{
  file="xsim.ini"
  lib_map_path="/opt/Xilinx/Vivado/2017.2/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
...
map_local_libs()
{
  ...
  local_libs=(xil_defaultlib util_ds_buf_v2_01_a)
