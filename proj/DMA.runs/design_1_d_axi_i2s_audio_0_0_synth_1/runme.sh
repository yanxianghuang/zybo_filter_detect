...
HD_PWD='/home/yanxiang/Develop/vivado/back/Zybo-DMA/proj/DMA.runs/design_1_d_axi_i2s_audio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_d_axi_i2s_audio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_d_axi_i2s_audio_0_0.tcl
