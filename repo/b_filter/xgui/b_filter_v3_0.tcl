...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "WAITCYCLE" -parent ${Page_0}
...
proc update_PARAM_VALUE.WAITCYCLE { PARAM_VALUE.WAITCYCLE } {
	# Procedure called to update WAITCYCLE when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.WAITCYCLE { PARAM_VALUE.WAITCYCLE } {
	# Procedure called to validate WAITCYCLE
	return true
}
...
proc update_MODELPARAM_VALUE.WAITCYCLE { MODELPARAM_VALUE.WAITCYCLE PARAM_VALUE.WAITCYCLE } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.WAITCYCLE}] ${MODELPARAM_VALUE.WAITCYCLE}
}
