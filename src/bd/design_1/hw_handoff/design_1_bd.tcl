...
CONFIG.NUM_SI {2} \
  ...
  set b_filter_0 [ create_bd_cell -type ip -vlnv user.org:user:b_filter:8.5 b_filter_0 ]
...
CONFIG.NUM_PORTS {4} \
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M04_AXI [get_bd_intf_pins b_filter_0/S00_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M04_AXI]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK2 [get_bd_pins b_filter_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins processing_system7_0_axi_periph/M04_ACLK] [get_bd_pins rst_ps7_0_40M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_processing_system7_0_100M/ext_reset_in] [get_bd_pins rst_ps7_0_40M/ext_reset_in]
  ...
  connect_bd_net -net rst_ps7_0_40M_peripheral_aresetn [get_bd_pins b_filter_0/s00_axi_aresetn] [get_bd_pins processing_system7_0_axi_periph/M04_ARESETN] [get_bd_pins rst_ps7_0_40M/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs b_filter_0/S00_AXI/S00_AXI_reg] SEG_b_filter_0_S00_AXI_reg
